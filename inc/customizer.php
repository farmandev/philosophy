 ...
 */
function philosophy_customize_preview_js() {
	wp_enqueue_script( 'philosophy-customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), _S_VERSION, true );
}
add_action( 'customize_preview_init', 'philosophy_customize_preview_js' );
