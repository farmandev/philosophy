...
function philosophy_scripts() {
	wp_enqueue_style( 'philosophy-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'philosophy-style', 'rtl', 'replace' );

	wp_enqueue_script( 'philosophy-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
